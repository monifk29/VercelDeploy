...
//     getData(url)
    ...
    console.log(e)
       ...
       var yename = document.createElement("div");
       yename.setAttribute("id","yename")

       var kmcard = document.createElement("div");
       kmcard.setAttribute("id","kmcard");
       ...
       edit.innerText = "Edit"
        ...
        wishList.addEventListener("click", () => {
            let wish_url = "https://ancient-caverns-16282.herokuapp.com/wishlisted_cars"
       ...
       del.innerHTML = "Delete"
        del.addEventListener("click", async () => {
         ...
         await  fetch(`https://ancient-caverns-16282.herokuapp.com/cars/${id}`, {
  method: 'DELETE',
})
container.innerHTML = null
getData(url) 
        ...
        yename.append(year,brand);

        kmcard.append(kms);

        end.append(edit,del,wishList)
    
       card.append(img,yename,type,kmcard,price,des,end);
...
function handleFilter(){
    let link = `https://ancient-caverns-16282.herokuapp.com/cars?brand=${filter.value}`
    getData(link)
}
